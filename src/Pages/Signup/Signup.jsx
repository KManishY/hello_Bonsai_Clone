			...
			<Flex p={5} mt={40} bgColor='white' wrap='wrap'>
				...
				>
					...
					>
						<Box>
							...
							<Box mr={5} ml={2}>
								<Text>
									Join 500,000+ freelancers and agencies using
									Bonsai.
								</Text>
							</Box>
						</Box>
						...
						<Box p={5} mb={20}>
							<q>
								Anyone doing #freelance work should use
								@bonsaiinc for contracts/payment. It's amazing
								and saves boatloads of time.
							</q>
							<p>Nathanael Smith, Product Designer</p>
						</Box>
					</Flex>
				</Box>
				...
				<Container p={0} ml={0} maxW='container.sm'>
					...
					>
						...
						<br />
						{/* <Button></Button> */}
						<FormControl validate={validate} isInvalid={isError}>
							...
							<FormLabel color='rgb(171,170,170)' mt={5}>
								FULL NAME
							</FormLabel>
							<Input
								name='name'
						...
						<Box style={{ textAlign: "center" }}>
							...
							>
								By creating an acoount,you accept our
							</p>
							<p color='rgb(134,134,135)'>Terms and Conditions</p>
						</Box>
